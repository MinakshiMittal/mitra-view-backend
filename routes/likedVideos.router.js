...
.post(async(req, res) => {
  ...
  const videoPresent = _.some(interactingUser.likedVideos, (likedVideo) => likedVideo.video.toString() === video.video);
  ...
  interactingUser.likedVideos.addToSet(video);
